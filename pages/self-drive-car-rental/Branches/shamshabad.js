...
import commander from '../../images/commanderbranch.webp'
function shamshabad() {

    return (
        <div className='text-black pt-48 lg:py-12 lg:px-14 px-4 text-base leading-8 mont-text'>
            <h1 className='font-bold text-base lg:text-4xl'>Explore the variety of self-drive car services in Shamshabad</h1>
            <Image
                src={commander}
                height={500}
                width={500}
            ...
            <p>Chilkur Balaji Temple, sometimes called the "Visa Temple," is a well-liked destination for pilgrims. It's a wonderful location for a calm getaway because of the beautiful surroundings and spiritual atmosphere.</p>
            <p className='font-bold'>Golconda Castle</p>
            <p>Golconda Fort is a magnificent sight with its elaborate architecture and rich history, dating back to the 16th century. It is a medieval fortification. The expansive views from the fort are an extra benefit.</p>
