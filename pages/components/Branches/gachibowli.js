...
import safari from '../../images/starletbranch.webp'
function Gachibowli() {

    return (
        <div className='text-black pt-48 lg:py-12 lg:px-14 px-4 text-xs leading-8 mont-text'>
            <h1 className='font-bold text-sm lg:text-4xl'>Drive yourself around Hyderabad with self-drive cars from Gachibowli </h1>
            <p className='font-bold text-sm lg:text-3xl'>Discover Hyderabad on Your Terms</p>
            <Image
                src={safari}
                height={500}
                width={500}
            ...
            <p className='font-bold lg:text-xl py-2'>Why Choose Self-Drive in Gachibowli?</p>
            <ul>
            ...
            <p className='font-bold lg:text-xl py-2'>From City Escapes to Weekend Getaways </p>
            ...
            <ul>
                <li>
                    <p className='font-bold lg:text-xl py-2'>Lonavala and Khandala: The Twin Hill Stations</p>
                ...
                <li>
                    <p className='font-bold lg:text-xl py-2'>Mahabaleshwar: The Queen of Hill Stations</p>
                ...
                <li>
                    <p className='font-bold lg:text-xl py-2'>Aurangabad: The City of Gates </p>
            ...
            <p className='font-bold lg:text-xl py-2'>Experience Unmatched Convenience</p>
            ...
            <p className='font-bold lg:text-xl py-2'>Your Journey Starts Here</p>
