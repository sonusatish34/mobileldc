    ...
    <div className="min-h-screen">
      ...
      <div>
        <div className='text-center'>
          <h2 id='explore' className="px-3 font-bold text-xl pb-4 pt-8 text-blue-950 mb-2 lg:text-5xl lg:mb-9">Explore Self Drive Car Rentals Near You In 20km</h2>
        </div>
        <div className=' lg:mb-16 flex flex-grow items-center pl-3'>
          <input
